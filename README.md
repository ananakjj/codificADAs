...
<head>
   ...
   <style>
       ...
       * {
       ...
       #disney {
       color: rgb(0, 0, 0); /* Cor do link antes de ser clicado */
       text-decoration: none; /* Remove o sublinhado */
   }


   #disney:visited {
       color: rgb(0, 0, 0); /* Cor do link após ser clicado */
   }
   ...
   a {
       color: rgb(255, 255, 255); /* Cor do link antes de ser clicado */
       text-decoration: none; /* Remove o sublinhado */
   }


   a:visited {
       color: rgb(255, 255, 255); /* Cor do link após ser clicado */
   }
...
<body>
   ...
   <section>
       <h2>Onde Assistir</h2>
       <p>
           Prepare-se para uma imersão em um universo mágico e emocionante. Acesse o streaming e deixe Star Wars te transportar para uma galáxia muito, muito distante...
       </p>


       <div style="text-align: center;">
           <a id="disney" href="https://www.disneyplus.com/pt-br" target="_blank">
               <button style="background-color: #ffd700; color:#000 ; padding: 10px 20px; margin: 10px; border: none; border-radius: 10px; cursor: pointer;">
                   Disney+
         </a>
       </div>
   </section>
